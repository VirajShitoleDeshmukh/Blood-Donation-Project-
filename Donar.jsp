...
<body>
	...
	<div class="card text-center"
		...
		<div class="card-header">
			<ul class="nav nav-pills card-header-pills">
				<li class="nav-item"><a class="nav-link " href="FindDonor.jsp">Find
						Blood</a></li>
		...
		<div class="card-body">
			...
			<jsp:include page="find_donor_form.jsp"></jsp:include>
	...
	<div class="card text-center"
		...
		<div class="card-header">
			<ul class="nav nav-pills card-header-pills">
				<li class="nav-item"><a class="nav-link active" href="#">Donor List</a></li>
	
			</ul>
		</div>
		<div class="card-body">

			<jsp:include page="donor_controllar.jsp"></jsp:include>
