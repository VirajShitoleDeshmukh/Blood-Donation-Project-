...
<body>
	...
	<div class="container mt-5" style="background-color: #f8f9fa; width: 100%; padding: 20px; border-radius: 10px; margin-top: 5px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.2);">
		...
		<form action="index_controller.jsp" >
	...
	<div class="container-down" style="margin-top: 200px; padding: 100px;">
		...
		<div class="row">
			<div class="col">
				...
				<p style="text-align: center;" class="enlarge">This National
					Portal is dedicated to information on Blood Services
					and Resources. Service is the policy formulating apex body in relation
					...
					Transfusion Councils and also ensures the involvement of
					other Ministries and other health programs for various activities
					related to Blood Services.</p>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="service-content">
					<a href="/BD/Donor/register_donor_form.jsp"><h3>Register as a Donor</h3></a>
