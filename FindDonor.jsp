...
<body>
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item"><a class="nav-link"
						href="/BD/OrganizeCamp/OrgananizeCamp.jsp" style="color: black;">ORGANIZE
							CAMP </a></li>
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="/BD/About/AboutUs.jsp" style="color: black;">
							ABOUT US </a></li>
					<li class="nav-item"><a class="nav-link"
						href="/BD/Gallery/gallery.jsp" style="color: black;"> GALLERY
					</a></li>
					<li class="nav-item"><a class="nav-link"
						href="/BD/Blog/Blog.jsp" style="color: black;"> BLOG </a></li>
					<li class="nav-item"><a class="nav-link"
	...
	<div class="card text-center"
		style="margin-top: 20px; margin-left:100px; width: 1200px; height: 300px; opacity: 0.9;">
		<div class="card-header">
			<ul class="nav nav-pills card-header-pills">
				<li class="nav-item"><a class="nav-link active" href="#">Find
						Blood</a></li>
				<li class="nav-item"><a class="nav-link" href="Donar.jsp">Find
						Donor </a></li>
		...
		<div class="card-body">
			...
			<jsp:include page="find_blood_form.jsp"></jsp:include>

		</div>
		
		<div class="card text-center"
		style="margin-top: 20px; margin-left:100px; width: 1200px; height: 270px; opacity: 0.9;">
		<div class="card-header">
			<ul class="nav nav-pills card-header-pills">
				<li class="nav-item"><a class="nav-link active" href="#">Blood Bank List</a></li>
	
			</ul>
		</div>
		<div class="card-body">

			<jsp:include page="find_blood_controllar.jsp"></jsp:include>
