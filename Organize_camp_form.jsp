...
<body>
	...
	<div class="container mt-5">
		   <h2>Organize Blood Drive</h2>
         <div class="container mt-5">
        <h2 class="mb-4">Organize Blood Drive</h2>
        <div class="row">
            <div class="col-md-6">
                <form action=" Organize_camp_form.jsp">
                    <div class="mb-3">
            ...
            <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        <label for="organizerName" class="form-label">Organizer's Name</label>
...
out.print(eventName);
	...
	RegisterForm.organize_Blood_Drive(eventName,eventDate,location,organizerName,contactEmail);
