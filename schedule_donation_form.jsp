...
<body>
	...
	<div class="container mt-5"
		style="background-color: #f8f9fa; width: 100%; padding: 20px; border-radius: 10px; margin-top: 5px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.2);">
		<h2>Schedule Blood Donation</h2>
		<div class="row">
			<div class="col-md-6">
				<!-- Left Column -->
				<form action="schedule_donation_form.jsp">
					<div class="mb-3">
			...
			<div class="col-md-6">
				...
				<div class="mb-3">
					<label for="bloodType" class="form-label">Blood Type</label> <select
						class="form-select" id="bloodType" name="blood_type" required>
				...
				<div class="mb-3">
					<label for="donationDate" class="form-label">Preferred
						Donation Date</label> <input type="date" class="form-control"
						id="donationDate" name="donation_date" required>
				</div>
				<div class="mb-3">
					<label for="bloodBank" class="form-label">Select a Nearby
						Blood Bank</label> <select class="form-select" id="bloodBank"
						name="blood_bank" required>
						<option value="" selected>Select a blood bank</option>
						<option value="Pune">Pune</option>
						<option value="Mumbai">Mumbai</option>
						<!-- Add options for nearby blood banks here -->
					</select>
				</div>

				<button type="submit" class="btn btn-outline-success">Schedule
					Donation</button>
	...
	<div class="container-down" style="margin-top: 200px; padding: 100px;">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="service-content"
					...
					<a href="/BD/index.jsp"><h3>Find Blood Banks</h3></a>
