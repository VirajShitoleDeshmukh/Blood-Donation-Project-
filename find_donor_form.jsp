...
<body>
	...
	<div class="card border-success mb-3"
		...
		<div class="card-header bg-transparent border-success"
			style="text-align: center">Find Donor</div>
		<div class="card-body text-success">
				...
				<label class="my-1 mr-2" for="inlineFormCustomSelectPref"style="margin-left: 50px;">Select Organ</label>
				<select class="custom-select my-1 mr-sm-2"
					id="inlineFormCustomSelectPref" name="blood_group" style="width: 200px;">
					<option selected> Select </option>
					<option selected> Select </option>
					<option value="A">Eye</option>
