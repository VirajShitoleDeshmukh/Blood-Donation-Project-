...
<body>
    ...
    <div class="container-down" style="margin-top:200px; padding:100px;">
        ...
        <div class="row">
            <div class="col">
                 <h2 style="text-align: center; margin-top: 0px">Welcome to
                the website of National Blood Donation.</h2>
            <p style="text-align: center;" class="enlarge">This National
                ...
                to all matters pertaining to the operation of blood centers. The NBTC
                is the central body that coordinates with the State Blood
                Transfusion Councils (SBTCs) and also ensures the involvement of other
                Ministries and other health programs for various activities related to Blood Transfusion Services (BTS).</p>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="service-content"
                            ...
                            <p>Find blood banks and blood availability across the
                                nation.*</p>
                        </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="service-content last">
                            ...
                            <p>Get engaged by organizing a blood drive or blood camp
                                with us.</p>
                        </div>
            </div>
        </div>
...
<a href="#"><h3>Eligibility Requirements</h3></a>
                                    <p>Learn more about the eligibility requirements for
                                        donating blood.</p>                    </div>
                </div>
                <!-- Row 4 -->
                <div class="row">
                    <div class="col-md-12">
